        ...
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden lg:flex items-center space-x-6">
            <button 
              ...
              className="flex items-center gap-2 text-[10px] font-black uppercase tracking-widest hover:text-primary-600 transition-colors"
            >
          ...
          <div className="flex items-center space-x-2 md:space-x-4">
            ...
            {user ? (
              <div className="relative" ref={userMenuRef}>
                ...
                {isUserMenuOpen && (
                  <div className="absolute right-0 mt-4 w-64 bg-white dark:bg-slate-900 border-2 border-slate-100 dark:border-slate-800 rounded-[2rem] shadow-[0_30px_60px_rgba(0,0,0,0.1)] py-4 z-50 animate-in zoom-in-95 duration-200">
                    ...
                    <div className="px-6 py-2">
                      <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1">Personal Hub</p>
                    </div>
                    
                    <a href="#/cart" className="flex items-center justify-between px-6 py-3 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors group" onClick={() => setIsUserMenuOpen(false)}>
                    ...
                    <a href="#/shop" className="flex items-center justify-between px-6 py-3 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors group" onClick={() => setIsUserMenuOpen(false)}>
                      <div className="flex items-center">
                    ...
                    <a href="#/orders" className="flex items-center px-6 py-3 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors group" onClick={() => setIsUserMenuOpen(false)}>
                    ...
                    <a href="#/profile" className="flex items-center px-6 py-3 text-sm font-bold hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors" onClick={() => setIsUserMenuOpen(false)}>
